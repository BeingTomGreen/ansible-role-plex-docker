...
Since you're already here, why not look at [Jellyfin](https://plex.org/) instead, it's like Plex, but better, I have a [role for that too](https://github.com/BeingTomGreen/ansible-role-jellfin-docker).
